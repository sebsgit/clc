...
void clc_encrypt_data_24( unsigned char * in, clc_aes_key_192 * key, long data_len ){
...
void clc_decrypt_data_24( unsigned char * in, clc_aes_key_192 * key, long data_len ){
	const long c = data_len/16;
	long i;
	clc_bytes_16 b;
	clc_expand_key_24(key);
